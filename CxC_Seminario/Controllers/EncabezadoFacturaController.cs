    ...
    public class EncabezadoFacturaController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await client.GetAsync("api/EncabezadoFactura/GetOneById/?id= " + id);
        ...
        public ActionResult Edit(EncabezadoFactura entidad)
        {
            using (var client = new HttpClient())
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var postTask = client.PostAsync("api/EncabezadoFactura/Updated", byteContent).Result;
