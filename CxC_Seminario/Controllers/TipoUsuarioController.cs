    ...
    public class TipoUsuarioController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await client.GetAsync("api/TipoUsuario/GetOneById/5?id= " + id);
        ...
        [HttpPost]
        public ActionResult Create(TipoUsuario entidad)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(baseurl);
        ...
        [HttpPost]
        public ActionResult Edit(TipoUsuario entidad)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(baseurl);
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var postTask = client.PostAsync("api/TipoUsuario/Update", byteContent).Result;
