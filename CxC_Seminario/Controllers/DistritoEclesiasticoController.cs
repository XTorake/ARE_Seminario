    ...
    public class DistritoEclesiasticoController : Controller
    {
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                client.DefaultRequestHeaders.Clear();
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                HttpResponseMessage res = await client.GetAsync("api/DistritoEclesiastico/GetOneById/5?id= " + id);
        ...
        public ActionResult Edit(DistritoEclesiastico entidad)
        {
            using (var client = new HttpClient())
            {
                ...
                var byteContent = new ByteArrayContent(buffer);
                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
                var postTask = client.PostAsync("api/DistritoEclesiastico/Update", byteContent).Result;
